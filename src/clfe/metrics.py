...
class MetricsTop:
    """Subset of metric utilities for MOSI/MOSEI/SIMS-style regression outputs.

    This is mainly useful for computing MOSEI-style scores on model predictions.
    """

    def __init__(self):
        self.metrics_dict = {
            "MOSI": self.__eval_mosei_regression,
    ...
    def __eval_mosei_regression(self, y_pred, y_true, exclude_zero: bool = False):
    ...
    def get_metrics(self, dataset_name: str):
        return self.metrics_dict[dataset_name.upper()]
